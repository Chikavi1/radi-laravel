    ...
    >
        ...
        <div class="flex flex-col-reverse">
            ...
            <div class="sharing-buttons flex flex-wrap">
                ...
                <a class="border-2 duration-200 ease inline-flex items-center mb-1 mr-1 transition p-1 rounded-full text-white border-purple-600 bg-purple-600 hover:bg-purple-700 hover:border-purple-700" target="_blank" rel="noopener" href="https://twitter.com/intent/tweet?url=https%3A%2F%2Fwww.radi.pet%2Forg%2F{{$hash}}&amp;text=Descubre%20el%20perfil%20de%20{{$org->name}}%0A%C2%A1Ay%C3%BAdanos%20a%20mejorar%20la%20vida%20de%20miles%20de%20mascotas!" aria-label="Share on Twitter">
                  <svg aria-hidden="true" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-4 h-4">
                    <title>Twitter</title>
                ...
                <a class="border-2 duration-200 ease inline-flex items-center mb-1 mr-1 transition p-1 rounded-full text-white border-purple-600 bg-purple-600 hover:bg-purple-700 hover:border-purple-700" target="_blank" rel="noopener" href="https://wa.me/?text=Descubre%20el%20perfil%20de%20{{$org->name}}%0A%C2%A1Ay%C3%BAdanos%20a%20mejorar%20la%20vida%20de%20miles%20de%20mascotas!%20https%3A%2F%2Fwww.radi.pet%2Forg%2F{{$hash}}" aria-label="Share on Whatsapp" draggable="false">
                  <svg aria-hidden="true" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-4 h-4">
                ...
                <a class="border-2 duration-200 ease inline-flex items-center mb-1 mr-1 transition p-1 rounded-full text-white border-purple-600 bg-purple-600 hover:bg-purple-700 hover:border-purple-700" target="_blank" rel="noopener" href="https://telegram.me/share/url?text=Descubre%20el%20perfil%20de%20{{$org->name}}%0A%C2%A1Ay%C3%BAdanos%20a%20mejorar%20la%20vida%20de%20miles%20de%20mascotas!&amp;url=https%3A%2F%2Fwww.radi.pet%2Forg%2F{{$hash}}" aria-label="Share on Telegram" draggable="false">
                  <svg aria-hidden="true" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-4 h-4">
                ...
                <a class="border-2 duration-200 ease inline-flex items-center mb-1 mr-1 transition p-1 rounded-full text-white border-purple-600 bg-purple-600 hover:bg-purple-700 hover:border-purple-700" target="_blank" rel="noopener" href="mailto:?subject=Descubre%20el%20perfil%20de%20{{$org->name}}%0A%C2%A1Ay%C3%BAdanos%20a%20mejorar%20la%20vida%20de%20miles%20de%20mascotas!&amp;body=https%3A%2F%2Fwww.radi.pet%2Forg%2F{{$hash}}" aria-label="Share by Email" draggable="false">
                  <svg aria-hidden="true" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-4 h-4">
                    <title>Email</title>
