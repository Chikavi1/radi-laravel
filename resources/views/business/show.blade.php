@include('layouts.nav')
    ...
    <div class="grid grid-cols-12">
        ...
        <div class="col-span-12 md:col-span-6">
            <div class="h-72 md:rounded-md z-10" style="background: {{$business->bg_color}}">
                <div class="grid grid-cols-12">
                    <div class="col-span-4">
                        <img class="m-6 w-24 h-24 md:w-40 md:h-40 rounded-full mt-16 md:mt-2" src="{{$business->image}}" alt="imagen">
                    </div>
                    <div class="col-span-8">
                        <h1 class="text-xl md:text-4xl text-center mt-24 md:mt-16" style="color: {{$business->fn_color}}">{{$business->name}}</h1>
                    </div>
                </div>
            </div>
            <div class="-mt-16  shadow-md p-4 mx-4 md:mx-16 bg-white rounded-xl">

                <div class="inline-block mt-4">
                    <a target="_blank" href="{{$business->ig_url}}" class="text-2xl my-2"><i class="fa-brands fa-instagram"></i></a>
                    <a target="_blank" href="{{$business->fb_url}}" class="text-2xl my-2"><i class="fa-brands fa-facebook"></i></a>
                    <a target="_blank" href="{{$business->web_url}}" class="text-2xl my-2"><i class="fa-regular fa-window-maximize"></i></a>
                </div>
                @switch($business->type)
                @case(0)
                    <h2 class="mt-2 font-bold">Todos</h2>
                    @break
                @case(1)
                    <h2 class="mt-2 font-bold">Especial</h2>
                    @break
                @case(2)
                    <h2 class="mt-2 font-bold">Parque</h2>
                    @break
                @case(3)
                    <h2 class="mt-2 font-bold">Estilista</h2>
                    @break
                @case(4)
                    <h2 class="mt-2 font-bold">Veterinaria</h2>
                    @break
                @case(5)
                    <h2 class="mt-2 font-bold">Lugar Petfriendly</h2>
                    @break
                @case(6)
                    <h2 class="mt-2 font-bold">Guarderia</h2>
                    @break
                @case(7)
                ...
                @default
                        <span>Sin Tipo</span>
                @endswitch
                <p class="mt-4 capital">{{$business->description}}</p>

                <h2 class="mt-10 text-xl font-bold">Promociones</h2>
                @if(count($business->discounts) != 0)
                <div class="grid grid-cols-12 mt-12">

                    @foreach($business->discounts as $promotion)
                    <div class="col-span-12 md:col-span-6">
                                <a href="#">
                                <img src="{{$promotion->image}}" class="object-cover w-full h-56 mb-5 bg-center rounded" alt="Kutty" loading="lazy" />
                                </a>
                                <h2 class="capital mb-2 text-lg font-semibold text-gray-900">
                                <a href="#" class="capital text-gray-900 hover:text-purple-700">{{$promotion->title}}</a>
                                </h2>
                                <p class="capital mb-3 text-sm font-normal text-gray-500">
                        ...
                        <div class="grid grid-cols-12 mt-12">
                            <div class="col-span-12 md:col-span-6">
                                <a target="_blank" href="/events/{{$event->id}}">
                                    ...
                                    <p class="truncate capital mb-3 text-sm font-normal text-gray-500">
                                        {{ $event->description}}
                                    </p>
                                </a>
                                </div>
                ...
                <p class="capital">{{$business->address}}</p>
                ...
                <div
                    ...
                    <div class="flex flex-col-reverse">
                        ...
                        <div class="sharing-buttons flex flex-wrap">
                            ...
                            <a class="border-2 duration-200 ease inline-flex items-center mb-1 mr-1 transition p-1 rounded-full text-white border-purple-700 bg-purple-700 hover:bg-purple-700 hover:border-purple-700" target="_blank" rel="noopener" href="https://twitter.com/intent/tweet?url=https%3A%2F%2Fradi.pet%2Fbusiness%2F{{$hash}}&text=Ay%C3%BAdame%20a%20encontrar%20a%20mi%20mascota%2C%20por%20favor%20se%20llama%20{{$business}}" aria-label="Share on Twitter">
                            <svg aria-hidden="true" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-4 h-4">
                                <title>Twitter</title>
                            ...
                            <a class="border-2 duration-200 ease inline-flex items-center mb-1 mr-1 transition p-1 rounded-full text-white border-purple-700 bg-purple-700 hover:bg-purple-700 hover:border-purple-700" target="_blank" rel="noopener" href="https://wa.me/?text=Ay%C3%BAdame%20a%20encontrar%20a%20mi%20mascota%2C%20por%20favor%20se%20llama%20{{$business}}%20https%3A%2F%2Fradi.pet%2Fbusiness%2F{{$hash }}" aria-label="Share on Whatsapp" draggable="false">
                            <svg aria-hidden="true" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-4 h-4">
                            ...
                            <a class="border-2 duration-200 ease inline-flex items-center mb-1 mr-1 transition p-1 rounded-full text-white border-purple-700 bg-purple-700 hover:bg-purple-700 hover:border-purple-700" target="_blank" rel="noopener" href="https://telegram.me/share/url?text=Ay%C3%BAdame%20a%20encontrar%20a%20mi%20mascota%2C%20por%20favor%20se%20llama%20{{$business}}url=https%3A%2F%2Fradi.pet%2Fbusiness%2F{{$hash }}" aria-label="Share on Telegram" draggable="false">
                            <svg aria-hidden="true" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-4 h-4">
                            ...
                            <a class="border-2 duration-200 ease inline-flex items-center mb-1 mr-1 transition p-1 rounded-full text-white border-purple-700 bg-purple-700 hover:bg-purple-700 hover:border-purple-700" target="_blank" rel="noopener" href="mailto:?subject=Ay%C3%BAdame%20a%20encontrar%20a%20mi%20mascota%2C%20por%20favor%20se%20llama%20{{$business}}body=https%3A%2F%2Fradi.pet%2Fbusiness%2F{{$hash }}" aria-label="Share by Email" draggable="false">
                            <svg aria-hidden="true" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-4 h-4">
                                <title>Email</title>
