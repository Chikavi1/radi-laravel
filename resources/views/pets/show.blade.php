  ...
  <div >
    <div class="grid grid-cols-12 ">
      <div class="col-span-12 md:col-span-10 md:col-start-2 xl:col-span-8 xl:col-start-3  lg:px-20">
        <img src="{{$pet->photo}}" class="md:object-cover md:w-5/6 md:h-96 md:mx-auto w-full rounded-md" alt="profile image">
        <div class="p-4">
              ...
              <div class="rounded-2xl bg-gradient-to-r from-blue-900 via-blue-900 to-blue-900 p-1 shadow-xl">
                <a target="_blank" class="block rounded-xl bg-white p-4 sm:p-6 lg:p-8" >
                  <div class="">
                    ...
                    @if ($pet->gender == 1)
                        <p  *ngIf="$pet->gender == 1" class="mt-2 text-sm text-gray-500">
                        Hembra
                        </p>
                    @else
                        <p  *ngIf="$pet->gender == 2" class="mt-2 text-sm text-gray-500">
                        Macho
                        </p>
                    @endif
                  </div>
            ...
            <div
                ...
                <div class="flex flex-col-reverse">
                    ...
                    <div class="sharing-buttons flex flex-wrap">
                        ...
                        <a class="border-2 duration-200 ease inline-flex items-center mb-1 mr-1 transition p-1 rounded-full text-white border-purple-600 bg-purple-600 hover:bg-purple-700 hover:border-purple-700" target="_blank" rel="noopener" href="https://twitter.com/intent/tweet?url=https%3A%2F%2Fwww.radi.pet%2Fpet%2F{{$hash}}&amp;text=Conoce%20el%20perfil%20de%20{{$pet->name}}%20en%20Radi%20Pets%0A" aria-label="Share on Twitter">
                          <svg aria-hidden="true" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-4 h-4">
                            <title>Twitter</title>
                        ...
                        <a class="border-2 duration-200 ease inline-flex items-center mb-1 mr-1 transition p-1 rounded-full text-white border-purple-600 bg-purple-600 hover:bg-purple-700 hover:border-purple-700" target="_blank" rel="noopener" href="https://wa.me/?text=Conoce%20el%20perfil%20de%20{{$pet->name}}%20en%20Radi%20Pets%0A%20https%3A%2F%2Fwww.radi.pet%2Fpet%2F{{$hash}}" aria-label="Share on Whatsapp" draggable="false">
                          <svg aria-hidden="true" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-4 h-4">
                        ...
                        <a class="border-2 duration-200 ease inline-flex items-center mb-1 mr-1 transition p-1 rounded-full text-white border-purple-600 bg-purple-600 hover:bg-purple-700 hover:border-purple-700" target="_blank" rel="noopener" href="https://telegram.me/share/url?text=Conoce%20el%20perfil%20de%20{{$pet->name}}%20en%20Radi%20Pets%0A&amp;url=https%3A%2F%2Fwww.radi.pet%2Fpet%2F{{$hash}}" aria-label="Share on Telegram" draggable="false">
                          <svg aria-hidden="true" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-4 h-4">
                        ...
                        <a class="border-2 duration-200 ease inline-flex items-center mb-1 mr-1 transition p-1 rounded-full text-white border-purple-600 bg-purple-600 hover:bg-purple-700 hover:border-purple-700" target="_blank" rel="noopener" href="mailto:?subject=Conoce%20el%20perfil%20de%20{{$pet->name}}%20en%20Radi%20Pets%0A&amp;body=https%3A%2F%2Fwww.radi.pet%2Fpet%2F{{$hash}}" aria-label="Share by Email" draggable="false">
                          <svg aria-hidden="true" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-4 h-4">
                            <title>Email</title>
