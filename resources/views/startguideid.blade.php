...
<section class="px-4 py-24 mx-auto max-w-7xl">
    <div class="w-full mx-auto text-left md:w-11/12 xl:w-9/12 md:text-center">
      <h1 class="mt-12 md:mt-2 animate__animated animate__slideInDown mb-6 text-4xl font-semibold leading-none tracking-normal text-gray-900 md:text-6xl md:tracking-tight">
        Bienvenido a la nueva experiencia de las Placas de identificacion      </h1>
...
<h2 class="text-center text-2xl md:text-5xl my-12 md:my-20">Puedes hacer más con tus placas</h2>

<div class="m-4 md:m-0 grid grid-cols-12 gap-4">
        ...
        <article class="overflow-hidden rounded-lg shadow transition hover:shadow-lg">
            ...
            <div class="bg-white p-4 sm:p-6">
              ...
              <p class="mt-2 line-clamp-3 text-sm/relaxed text-gray-500">
                Si tu placa se encuentra en óptimas condiciones, puedes considerar donarla a una fundación. Ellos se ponen contacto con nosotros para activar la placa en modo organización.              </p>
            </div>
          </article>
    </div>
    <div class="col-span-12 md:col-span-6">
        <article class="overflow-hidden rounded-lg shadow transition hover:shadow-lg">
            ...
            <div class="bg-white p-4 sm:p-6">
              ...
              <a href="#">
                <h3 class="mt-0.5 text-lg text-gray-900">
                    Regala una placa de identificación a quien la necesita
                </h3>
              </a>

              <p class="mt-2 line-clamp-3 text-sm/relaxed text-gray-500">
                Puedes contribuir donando una placa especializada a los refugios de animales. Esta placa ha sido diseñada con características específicas que les permitirán gestionar de manera más eficaz la información de cada mascota       </p>
              </p>
            </div>
          </article>
