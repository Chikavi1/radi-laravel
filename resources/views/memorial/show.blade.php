            ...
            <article class="m-4 rounded-xl bg-white p-4 ring ring-indigo-50 sm:p-6 lg:p-8">
                <div class="flex items-start sm:gap-8">
                    <div>
                        ...
                        <p class="mt-6">
                            <a target="_blank"  href="/memorial/{{$memorial->setHiddenId()}}/comments" class="mt-8 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full">
            ...
            <button id="buttonShare" class="mt-4 bg-black hover:bg-black text-white font-bold py-2 px-4 rounded-full">
                ...
                <div
                    ...
                    <div class="sharing-buttons flex flex-wrap">
                        ...
                        <a class="border-2 duration-200 ease inline-flex items-center mb-1 mr-1 transition p-1 rounded-full text-white border-black bg-black hover:bg-black hover:border-black" target="_blank" rel="noopener" href="https://twitter.com/intent/tweet?url=https%3A%2F%2Fwww.radi.pet%2Fmemorial%2F{{$hash}}&amp;text=Memorial%20de%20mi%20{{$memorial->pets->name}}" aria-label="Share on Twitter">
                          <svg aria-hidden="true" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-4 h-4">
                            <title>Twitter</title>
                        ...
                        <a class="border-2 duration-200 ease inline-flex items-center mb-1 mr-1 transition p-1 rounded-full text-white border-black bg-black hover:bg-black hover:border-black" target="_blank" rel="noopener" href="https://wa.me/?text=Memorial%20de%20mi%20{{$memorial->pets->name}}%20https%3A%2F%2Fwww.radi.pet%2Fmemorial%2F{{$hash}}" aria-label="Share on Whatsapp" draggable="false">
                          <svg aria-hidden="true" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-4 h-4">
                        ...
                        <a class="border-2 duration-200 ease inline-flex items-center mb-1 mr-1 transition p-1 rounded-full text-white border-black bg-black hover:bg-black hover:border-black" target="_blank" rel="noopener" href="https://telegram.me/share/url?text=Memorial%20de%20mi%20{{$memorial->pets->name}}&amp;url=https%3A%2F%2Fwww.radi.pet%2Fmemorial%2F{{$hash}}" aria-label="Share on Telegram" draggable="false">
                          <svg aria-hidden="true" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-4 h-4">
