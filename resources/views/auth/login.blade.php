    ...
    <div class="flex flex-col w-full md:w-1/2">
        ...
        <div class="flex flex-col justify-center px-8 pt-8 my-auto md:justify-start md:pt-0 md:px-24 lg:px-32">
            ...
            <form method="POST" action="{{ route('login') }}" class="flex flex-col pt-3 md:pt-8">
                ...
                <div class="flex flex-col pt-4">
                    ...
                    <div class="text-center">
                        ...
                        <p class="mt-20">
                            No tienes cuenta?
                            <a href="/register" class="dark:text-white text-blue-800 font-bold" >
                                Registrate gratis
                            </a>
                    </div>
                </div>
            ...
            <div class="w-1/2 shadow-2xl">
                <img class="hidden object-cover w-full h-screen md:block" src="https://images.unsplash.com/photo-1521247560470-d2cbfe2f7b47?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80"/>
            </div>
        </div>
