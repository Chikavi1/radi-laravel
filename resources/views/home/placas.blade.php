...
<section class="px-4 py-24 mx-auto max-w-7xl">
  <div class="w-full mx-auto text-left md:w-11/12 xl:w-9/12 md:text-center">
    ...
    <div class="mx-auto ml-0 md:ml-58 lg:ml-72 get-app flex space-x-5 mt-10 justify-center md:justify-start">
  ...
  <section class="px-4 py-32 mx-auto max-w-7xl">
    <div class="w-full mx-auto lg:w-8/12 xl:w-5/12">
      ...
      <p class="mb-5 text-base text-gray-500 md:text-lg">
        Con nuestra app, podrás mantener el historial clínico y la información de tu mascota en un solo lado, siempre seguro. Además, podrás guardar tus paseos y conocer lugares pet friendly cerca de ti y planificar paseos divertidos y seguros para tu mascota.
      <br>  ¡Descarga la app hoy y haz que tus paseos con mascotas sean una aventura!
        <!-- <p>Proximamente</p> -->
