  ...
  <div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
    <div class="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-16">
      ...
      >
        <img
          alt="Party"
          src="https://images.unsplash.com/photo-1589924648735-e4ddb20adeee?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80"
...
<section class="px-4 py-20 mx-auto max-w-7xl lg:px-12" >
  <div class="grid items-center grid-cols-1 lg:grid-cols-2 gap-y-10 lg:gap-y-32 gap-x-10 lg:gap-x-24">
    <div>
      ...
      <p class="mb-6 text-lg text-center text-gray-600 sm:text-left md:text-xl">Conoce los requisitos para ser parte de Radi pets, Si estás interesado en formar parte de nuestra app y ofrecer descuentos, promociones o beneficios exclusivos, no dudes en registrarte. ¡Estamos emocionados de colaborar contigo!</p>
    </div>
    <div class="flex flex-col flex-grow space-y-5">
      <div class="flex items-start">
        ...
        <p class="text-lg text-gray-700">Logo de tu negocio y Nombre de tu negocio.</p>
      </div>
      <div class="flex items-start">
        <svg viewBox="0 0 20 20" fill="currentColor" class="flex-none w-5 h-5 mt-1 mr-2 text-primary">
          <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
        </svg>
        <p class="text-lg text-gray-700">Promociones que ofreces y las condiciones.</p>
      </div>
      <div class="flex items-start">
        <svg viewBox="0 0 20 20" fill="currentColor" class="flex-none w-5 h-5 mt-1 mr-2 text-primary">
          <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
        </svg>
        <p class="text-lg text-gray-700">URL de su web o de página de Facebook / Instagram. </p>
      </div>
      <div class="flex items-start">
        <svg viewBox="0 0 20 20" fill="currentColor" class="flex-none w-5 h-5 mt-1 mr-2 text-primary">
          <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
        </svg>
        <p class="text-lg text-gray-700">Dirección en caso de tener tienda física y en caso de tener e-commerce que zona abarcas.</p>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="mx-auto max-w-screen-2xl px-4 py-8 sm:px-6 lg:px-8">
    <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
      ...
      <div class="grid grid-cols-2 gap-4 md:grid-cols-1 lg:grid-cols-2">
        <img
          alt="dueña y perro"
          src="https://images.unsplash.com/photo-1549297161-14f79605a74c?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=386&q=80"
...
<div class="px-6 py-6 mx-12 bg-green-700 rounded-lg dark:bg-green-800 md:py-12 md:px-12 lg:py-16 lg:px-16 xl:flex xl:items-center">
  <div class="xl:w-0 xl:flex-1">
      ...
      <p class="max-w-3xl mt-3 text-lg leading-6 text-indigo-200">
        Aumentar tu visibilidad y conectar con una audiencia apasionada por las mascotas. ¡Te esperamos en Radi Pets!          </p>
  </div>
