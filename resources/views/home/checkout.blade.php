      ...
      <div class="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
          ...
          <form class="mt-5 grid gap-6">
            <div class="relative">
              ...
              <label class="peer-checked:border-2 peer-checked:border-gray-700 peer-checked:bg-gray-50 flex cursor-pointer select-none rounded-lg border border-gray-300 p-4" for="radio_1">
                ...
                <div class="ml-5">
                  <span class="mt-2 font-semibold">Redpack</span>
                  <p>Gratis</p>
            ...
            <div class="relative">
              ...
              <label class="peer-checked:border-2 peer-checked:border-gray-700 peer-checked:bg-gray-50 flex cursor-pointer select-none rounded-lg border border-gray-300 p-4" for="radio_2">
                ...
                <div class="ml-5">
                  <span class="mt-2 font-semibold">Estafeta</span>
                  <p>$129.00 MXN</p>
                  <p class="text-slate-500 text-sm leading-6">Entrega de 2 a 6 días hábiles</p>
                </div>
              </label>
            </div>
          </form>
        ...
        <div class="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0">
            ...
            <div class="">
                <div class="grid grid-cols-12 gap-2">
                    ...
                    <div class="col-span-6">
                        ...
                        <div class="relative">
                            <input type="text" id="cellphone" name="cellphone" class="w-full rounded-md border border-gray-200 px-4 py-3 pl-11 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500" placeholder="52 1234 5678" />
                            <div class="pointer-events-none absolute inset-y-0 left-0 inline-flex items-center px-3">
          ...
          <div class="grid grid-cols-12 gap-2">
            ...
            <div class="col-span-6">
                <input type="text" name="billing-zip" class="w-full rounded-md border border-gray-200 px-4 py-3 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500" placeholder="Código Postal"  />
